...
parser.add_argument('--dataPath', type=str, default=normpath(join(root, 'dataPath')), help='Path for centroid data.')
parser.add_argument('--runsPath', type=str, default=normpath(join(root, 'runsPath')), help='Path to save runs to.')
parser.add_argument('--savePath', type=str, default=normpath(join(root, 'checkpoints')), 
        help='Path to save checkpoints to in logdir. Default=checkpoints/')
parser.add_argument('--cachePath', type=str, default=normpath(join(root, 'cache')), help='Path to save cache to.')
